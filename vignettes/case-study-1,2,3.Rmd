...
---
## Case study 1: 
### A comparative analysis of results derived from clinical trials (i.e., DASH and PREDIMED) juxtaposed with findings from an epidemiological study (i.e., NHANES) from 2017-2018, utilizing DASHI and MEDI dietary indexes

## Case study 2: 
### A time series of cross-sectional computation of the HEI2020 from 2005 to 2018

## Case study 3: 
### Comprehensive Calculation of Multiple Dietary indexes, using the NHANES data in 2017-2018
---
...
```{r, echo=FALSE, fig.width=20, fig.height=20, fig.fullwidth=TRUE}
...
ggplot(df_case1, aes(x=z_case1, y=y_case1, fill=x_case1)) + 
  ...
  geom_text(aes(label = round(y_case1, 2)), size = 6, vjust = -0.5, position = position_dodge(0.9)) +
...
x_case3 = c("DASHI", "MEDI", "HEI2020", "AHEI", "DII")
y_case3 = c(DASHI_1718_svymean_mean/9, MEDI_1718_svymean_mean/11, HEI2020_1718_svymean_mean/100, AHEI_1718_svymean_mean/110, 0.69)
# multiply all y values by 100 to get the percentage
y_case3 = y_case3*100
...
ggplot(df_case3, aes(x_case3, y_case3, fill=x_case3)) + 
  ...
  geom_text(aes(label = round(y_case3, 2)), vjust = -0.5, size = 6)
```
