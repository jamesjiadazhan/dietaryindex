...
.onAttach <- function(libname, pkgname) {
    ...
    packageStartupMessage("Cite us:  citation('dietaryindex') or
                            Jiada James Zhan, Rebecca A Hodge, Anne Dunlop, et al. Dietaryindex: A User-Friendly and Versatile R Package for Standardizing Dietary Pattern Analysis in Epidemiological and Clinical Studies. bioRxiv. Published online January 1, 2023:2023.08.07.548466. doi:10.1101/2023.08.07.548466")
}
