#' MED Calculation
#'
#' Calculate the alternate Mediterranean Diet Score using given the serving sizes of foods and nutrients consumed per 1 day
#' @import dplyr
#' @import readr
#' @import haven
...
#' @param ALCOHOL_SERV_MED The serving size of alcohol, unit=1g
...
# Score calculation for alternate Mediterranean Diet Score (MED)
    ...
    SERV_DATA %>%
        dplyr::mutate(
            ...
            MED_ALCOHOL = case_when(
                ALCOHOL_SERV_MED <= 15 & ALCOHOL_SERV_MED >= 5 ~ 1,
                TRUE ~ 0
            ),
