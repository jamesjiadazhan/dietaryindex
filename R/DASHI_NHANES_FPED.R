  ...
  if (!is.null(NUTRIENT_PATH)) {
    ...
    COHORT = COHORT %>%
        mutate(
            ...
            POTASSIUM_DASHI = DR1TKCAL / (DR1TKCAL/2000),
    ...
    COHORT = COHORT %>%
        ...
        dplyr::select(SEQN, DASHI_ALL, DASHI_TOTAL_FAT, DASHI_SAT_FAT, DASHI_CHOLESTEROL, DASHI_SODIUM,
                      DASHI_PROTEIN, DASHI_FIBER, DASHI_POTASSIUM, DASHI_MAGNESIUM, DASHI_CALCIUM)
                      }
    ...
    if (!is.null(NUTRIENT_PATH2)) {
        ...
        COHORT2 = COHORT2 %>%
            mutate(
                ...
                POTASSIUM_DASHI = DR2TKCAL / (DR2TKCAL/2000),
