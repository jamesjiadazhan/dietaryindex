#' HEI2020_ASA24
#'
#' Calculate the HEI2020 for the ASA24 data within 1 step
#' @import dplyr
#' @import readr
#' @import haven
#' @param DATA_PATH The file path for the data. The file name should be like: Totals.csv.
#' @return The average HEI2020 and its component scores for each individual per day.
#' @examples
#' data("ASA24_exp")
#' HEI2020_ASA24(ASA24_exp, RECALL_SUMMARIZE = TRUE)
#' @export

HEI2020_ASA24 = function(DATA_PATH, RECALL_SUMMARIZE = TRUE) {
    ...
    if (RECALL_SUMMARIZE == TRUE) {
        print("RECALL_SUMMARIZE = TRUE, summarizing HEI2020 for ASA24 data by averaging over all possible recalls per person per day...")
    ...
    # Calculate serving size needed for HEI2020 calculation
    COHORT = COHORT %>%
        dplyr::mutate(
    ...
    # calculate HEI2020 total and component scores
    COHORT = COHORT %>%
        dplyr::mutate(
            HEI2020_TOTALFRT = HEI2020_HEALTHY1(TOTALFRT_SERV, HEI2020_MIN_TOTALFRT_SERV, HEI2020_MAX_TOTALFRT_SERV),
            HEI2020_FRT = HEI2020_HEALTHY1(FRT_SERV, HEI2020_MIN_FRT_SERV, HEI2020_MAX_FRT_SERV),
            HEI2020_VEG = HEI2020_HEALTHY1(VEG_SERV, HEI2020_MIN_VEG_SERV, HEI2020_MAX_VEG_SERV),
            HEI2020_GREENNBEAN = HEI2020_HEALTHY1(GREENNBEAN_SERV, HEI2020_MIN_GREENNBEAN_SERV, HEI2020_MAX_GREENNBEAN_SERV),
            HEI2020_TOTALPRO = HEI2020_HEALTHY1(TOTALPRO_SERV, HEI2020_MIN_TOTALPRO_SERV, HEI2020_MAX_TOTALPRO_SERV),
            HEI2020_SEAPLANTPRO = HEI2020_HEALTHY1(SEAPLANTPRO_SERV, HEI2020_MIN_SEAPLANTPRO_SERV, HEI2020_MAX_SEAPLANTPRO_SERV),
            HEI2020_WHOLEGRAIN = HEI2020_HEALTHY2(WHOLEGRAIN_SERV, HEI2020_MIN_WHOLEGRAIN_SERV, HEI2020_MAX_WHOLEGRAIN_SERV),
            HEI2020_DAIRY = HEI2020_HEALTHY2(DAIRY_SERV, HEI2020_MIN_DAIRY_SERV, HEI2020_MAX_DAIRY_SERV),
            HEI2020_FATTYACID = HEI2020_HEALTHY2(FATTYACID_SERV, HEI2020_MIN_FATTYACID_SERV, HEI2020_MAX_FATTYACID_SERV),
            HEI2020_REFINEDGRAIN = HEI2020_UNHEALTHY(REFINEDGRAIN_SERV, HEI2020_MIN_REFINEDGRAIN_SERV, HEI2020_MAX_REFINEDGRAIN_SERV),
            HEI2020_SODIUM = HEI2020_UNHEALTHY(SODIUM_SERV, HEI2020_MIN_SODIUM_SERV, HEI2020_MAX_SODIUM_SERV),
            HEI2020_ADDEDSUGAR = HEI2020_UNHEALTHY(ADDEDSUGAR_SERV, HEI2020_MIN_ADDEDSUGAR_SERV, HEI2020_MAX_ADDEDSUGAR_SERV),
            HEI2020_SATFAT = HEI2020_UNHEALTHY(SATFAT_SERV, HEI2020_MIN_SATFAT_SERV, HEI2020_MAX_SATFAT_SERV),
    ...
    print("The results should be only used for HEI-2020 (non-toddlers, age > 2 years), not including HEI-Toddlers 2020 (age 1-2 years).")

    COHORT %>%
        dplyr::select(
            UserName, UserID, TOTALKCAL, HEI2020_ALL, HEI2020_TOTALFRT, HEI2020_FRT, HEI2020_VEG, HEI2020_GREENNBEAN,
            HEI2020_TOTALPRO, HEI2020_SEAPLANTPRO, HEI2020_WHOLEGRAIN, HEI2020_DAIRY,
            HEI2020_FATTYACID, HEI2020_REFINEDGRAIN, HEI2020_SODIUM, HEI2020_ADDEDSUGAR,
            HEI2020_SATFAT
        )
