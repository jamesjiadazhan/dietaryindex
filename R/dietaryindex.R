...
AHEI_F_ASA24 = function(DATA_PATH){
  ...
  COHORT = COHORT %>%
    ...
    dplyr::summarize(
      ...
      WGRAIN_F_SERV = sum(G_WHOLE/0.035274),
  ...
  COHORT %>%
    dplyr::select(UserName, AHEI_ALL, AHEI_NOETOH, AHEI_VEG, AHEI_FRT, AHEI_WGRAIN_F, AHEI_NUTSLEG, AHEI_N3FAT,
                  ...
                  ENERGY, VEG_SERV, FRT_SERV, WGRAIN_F_SERV, NUTSLEG_SERV, PUFA_SERV, N3FAT_SERV, SSB_FRTJ_SERV, 
...
AHEI_DHQ3 = function(DATA_PATH){
  ...
  DRINKS = c(10.6, 10.9, 11.1, 11.2, 1140.1, 1140.2, 1144.1, 1150.1, 1152.1) 
  SSB = c(COFFEE_TEA, DRINKS)
